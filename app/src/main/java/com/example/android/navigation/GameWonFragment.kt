...
class GameWonFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        Toast.makeText(
                ...
                "NumCorrect:${args.numCorrect}," +
                        "NumTotalQues: ${args.numQuestions}",
                Toast.LENGTH_LONG
        ).show()
    ...
    override fun onCreateOptionsMenu(menu: Menu?, inflater: MenuInflater?) {
        ...
        //Check if the activity resolves:  i.e; the intent can be handled:
        if (null==getShareIntent().resolveActivity(activity!!.packageManager)){
            //Intent cant be handled:
            // Hide the share icon:
...
//        val shareIntent: Intent = Intent(Intent.ACTION_SEND) // Intent.ACTION_SEND is useful for sharing.
...
//        return shareIntent
        ...
        // Library function for sharing intent
